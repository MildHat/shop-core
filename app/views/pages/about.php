        ...
        <div class="row clearfix">
            <div class="image-column col-md-6 col-sm-12 col-xs-12">
                <div class="inner-column">
                    <div class="image-box wow slideInLeft"><a href="images/resource/history.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/history.jpg" alt=""></a></div>
                </div>
            </div>
...
<!-- Testimonial Section -->
<section class="testimonial-section" style="background-image: url(images/background/quotes.jpg);">
    <div class="auto-container">
